"""
Django settings for calm_snow_41861 project.
...
ROOT_URLCONF = 'calm_snow_41861.urls'
...
WSGI_APPLICATION = 'calm_snow_41861.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "calm_snow_41861 API",
    "DESCRIPTION": "API documentation for calm_snow_41861 App",
    "VERSION": "v1",
}
